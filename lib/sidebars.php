...
function catalogs_sidebar_widgets()
{
  register_sidebar(array(
    'id' => 'primary-sidebar',
    'name' => esc_html__('Primary Sidebar', 'catalogs'),
    'description' => esc_html__('This sidebar appears in the blog posts page.', 'catalogs'),
...
foreach ($columns as $i => $column) {
  register_sidebar(array(
    ...
    'name' => sprintf(esc_html__('Footer Widgets Column %s', 'catalogs'), $i + 1),
    'description' => esc_html__('Footer widgets', 'catalogs'),
...
add_action('widgets_init', 'catalogs_sidebar_widgets');
