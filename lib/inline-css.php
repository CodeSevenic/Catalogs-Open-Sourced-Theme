...
$inline_styles_selectors = array(
  'a' => array(
    'color' => 'catalogs_accent_color'
  ),
  ':focus' => array(
    'outline-color' => 'catalogs_accent_color'
  ),
  '.c-post.sticky' => array(
    'border-left-color' => 'catalogs_accent_color'
  ),
  'button, input[type=submit], .header-nav .menu > .menu-item:not(.mega) .sub-menu .menu-item:hover a' => array(
    'background-color' => 'catalogs_accent_color'
  )
);
...
// $accent_color = sanitize_hex_color(get_theme_mod('catalogs_accent_color', '#20ddae'));
// $inline_styles = "
//  a {
//    color: {$accent_color}
//  }
