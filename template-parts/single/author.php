<div class="c-post-author u-margin-bottom-20">
  <h2 class="u-screen-reader-text"><?php esc_attr_e('About The Author', 'catalogs') ?></h2>
  <?php
  ...
  <div class="c-post-author__content">
    ...
    <div class="c-post-author__info">
      <a href="<?php echo esc_url($author_posts_url); ?>">
        <?php
        printf(esc_html(_n('%s post', '%s posts', $author_posts, 'catalogs')), number_format_i18n($author_posts));
        ?>
      </a>
    </div>
