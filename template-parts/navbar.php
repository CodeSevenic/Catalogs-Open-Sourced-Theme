<div class="parent-wrapper">
  ...
  <div id="navbar" class="o-container">
    <nav class="nav">
      <ul class="list-unstyled navbar-nav">
        <li class="has_child">
          <a href="/groceries/" class="is_category">Groceries</a>
          <div class="dropdown category-11-dropdown" id="menu-category-11-dropdown">
            <a href="/groceries/" title="Groceries"><strong class="title">Groceries</strong></a>
        ...
        <li class="has_child">
          <a href="/electronics/" class="is_category">Electronics</a>
          <div class="dropdown category-14-dropdown" id="menu-category-14-dropdown">
            <a href="/electronics/" title="Electronics"><strong class="title">Electronics</strong></a>
            <ul class="list-unstyled">
        ...
        <li class="has_child">
          <a href="/home-garden/" class="is_category">Home_&amp;_Garden</a>
          <div class="dropdown category-12-dropdown" id="menu-category-12-dropdown">
            <a href="/home-garden/" title="Home &amp; Garden"><strong class="title">Home &amp; Garden</strong></a>
            <ul class="list-unstyled">
        ...
        <li class="has_child">
          <a href="/clothing-footwear-sport/" class="is_category">Clothing</a>
          <div class="dropdown category-15-dropdown" id="menu-category-15-dropdown">
            <a href="/clothing-footwear-sport/" title="Clothing, Footwear, Sport"><strong class="title">Clothing, Footwear, Sport</strong></a>
            <ul class="list-unstyled">
        ...
        <li class="has_child">
          <a href="/health-beauty/" class="is_category">Health_&amp;_Beauty</a>
          <div class="dropdown category-16-dropdown" id="menu-category-16-dropdown">
            <a href="/health-beauty/" title="Health &amp; Beauty"><strong class="title">Health &amp; Beauty</strong></a>
            <ul class="list-unstyled">
        ...
        <li class="has_child">
          <a href="/miscellaneous/" class="is_category">Miscellaneous</a>
          <div class="dropdown category-17-dropdown" id="menu-category-17-dropdown">
            <a href="/miscellaneous/" title="Miscellaneous"><strong class="title">Miscellaneous</strong></a>
            <ul class="list-unstyled">
      ...
      <ul class="menu-bar">
        ...
        <li class="groceries-list">
          <a href="#">
            ...
            Groceries <i class="fas fa-angle-right"></i>
          </a>
        </li>
  ...
  <div class=" o-container drop-btn">
    <svg class="menu-ham" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
